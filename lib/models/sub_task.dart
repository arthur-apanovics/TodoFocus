...
class SubTask {
  ...
  /// Optional time estimate in minutes. Generated by the LLM during
  /// decomposition / breakdown, editable by the user via the estimate
  /// picker sheet. Visibility is controlled by [DisplayPreferences.showTimeEstimates]
  /// (with per-goal override via [Goal.showTimeEstimatesOverride]).
